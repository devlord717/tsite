    ...
    <Fragment>
      ...
      <section id='home'>
        ...
        >
          ...
          >
            ...
            <p className='text-2xl md:text-4xl py-2 font-semibold font-sans'>
              ...
              <span className='text-[#c72c6c] dark:text-[#07d0e5]'>
                {" "}
                Game <span className='text-white'></span>
              </span>
              Developer
            </p>
          ...
          <div
            className={
              "translate-x-[500px] transition-all opacity-0 duration-700 w-[448px] h-[319px] md:w-[448px] md:h-[319px] bg-cover m-auto md:m-0 mt-[40px] md:mt-0 bg-no-repeat"
            }
            ref={profileRef}
